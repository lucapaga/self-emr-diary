...
export class UserprofileService {
    ...
    // public buildClientPrincipal(clPrincipalID: string, clPrincipalName: string, azAadCP: AzAADClientPrincipal): ClientPrincipal {
    public buildClientPrincipal(base64ClientPrincipal: string): ClientPrincipal {
        const azAadCP: AzAADClientPrincipal = this._unpackClientPrincipalData(base64ClientPrincipal);
